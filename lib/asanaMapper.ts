export const ASANA_IMAGES = [
    "bird-dog.png", "bird-dog_balancing_tiger.png", "boat_pose.png", "bound_angle_pose.png", "bow_pose.png", "bridge_pose.png", "butterfly_pose.png",
    ...
    "crescent_lunge_twist.png", "crow_pose.png", "dancers_pose.png", "dolphin_pose.png", "downward_facing_dog.png",
    ...
    "half_monkey_pose.png", "full_monkey_pose.png", "garland_pose.png", "gate_pose.png", "goddess_pose.png", "half_boat_pose.png", "half_lift_pose.png",
    "half_lord_of_the_fishes_pose.png", "half_moon_pose.png", "half_splits_pose.png", "halfway_lift.png", "handstand.png", "happy_baby.png",
    ...
    "monkey_pose.png", "mountain_pose.png", "neck_circles.png", "noose_pose.png", "peacock_pose.png",
    "pigeon_pose.png", "plank_pose.png", "plow_pose.png", "puppy_pose.png", "pyramid_pose.png", "ragdoll_pose.png",
    "reclined_bound_angle.png", "reclined_hand_to_big_toe.png", "reclining_hero.png", "reverse_table_top.png", "reverse_warrior_right.png",
    "reversed_triangle_pose.png", "revolved_chair.png", "revolved_half_moon.png", "revolved_lunge.png", "scale_pose.png",
    ...
    "side_lunge_pose.png", "side_plank.png", "sleeping_pigeon.png", "sphinx_pose.png", "staff_pose.png",
    "standing_backbend.png", "standing_forward_fold_pose.png", "standing_hand_to_big_toe.png", "standing_split.png", "supine_spinal_twist_pose.png",
    "supported_headstand.png", "tabletop_pose.png", "thunderbolt_pose.png", "tortoise_pose.png",
    "tree_pose.png", "triangle_pose.png",
    "twisted_lizard.png", "upward_facing_dog.png", "upward_salute.png", "warrior_i_left.png", "warrior_ii_left.png", "warrior_iii.png", "wheel_pose.png", "wide-angle_seated_forward_fold.png",
...
export function getAsanaImage(name: string, sanskritName?: string): string | null {
    ...
    if (normName.includes('balancingtiger') || normName.includes('vyaghrasana') || normName.includes('tigerpose')) {
        normName = 'birddogbalancingtiger';
    }

    const checkMatch = (targetName: string, targetSanskrit?: string) => {
        for (const file of ASANA_IMAGES) {
            const normFile = normalize(file.replace(/\.(png|png|jpg)$/i, ''));
    ...
    console.log({ normName, normSanskrit, result })
